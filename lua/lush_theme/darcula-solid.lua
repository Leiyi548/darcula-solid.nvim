...
return lush(function()
	return {
		...
		LspDiagnosticsVirtualTextError({ fg = red }), -- "Error" diagnostic virtual text
		LspDiagnosticsVirtualTextWarning({ fg = yellow }), -- "Warning" diagnostic virtual text
		LspDiagnosticsVirtualTextInformation({ fg = fg }), -- "Information" diagnostic virtual text
		LspDiagnosticsVirtualTextHint({ fg = blue }), -- "Hint" diagnostic virtual text
		...
		Operator({ fg = fg }),
		Keyword({ Statement, gui = bf }), -- any other keyword
		Exception({ fg = red }),
